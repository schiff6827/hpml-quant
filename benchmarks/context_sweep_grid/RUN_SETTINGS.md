...
Older 2026-04-30 probe-style files are retained in this folder for provenance,
but `analyze.py` skips them because they measured the model/config context cap
rather than KV-cache capacity.
